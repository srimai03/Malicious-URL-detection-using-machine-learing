...
--
-- Host: localhost
-- Generation Time: Sep 16, 2022 at 12:56 PM
...
--
-- Database: `malicious_url_detection`
--
CREATE DATABASE IF NOT EXISTS `malicious_url_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `malicious_url_detection`;
...
('dzypyj2o5dgggzxq2nak6sob20d7shq7', 'eyJ1c2VyaWQiOjJ9:1oZAnO:NADRBOwspz_cNw8uRTA-33D1m7wy5-8IHlQtPZy7q8c', '2022-09-30 12:50:14.747755'),
...
('tfl3anperdq3a3s86lkq5fclconp2tld', 'eyJ1c2VyaWQiOjF9:1oZ9QN:VFbRUCDEb4cIZuFOBscwTNCpaAPYcVoxOfwl5TG7edw', '2022-09-30 11:22:23.126683'),
...
INSERT INTO `remote_user_clientregister_model` (`id`, `username`, `email`, `password`, `phoneno`, `country`, `state`, `city`, `gender`, `address`) VALUES
(1, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', 'Male', '#8728,4th Cross,Rajajinagar'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', 'Male', '#8928,4th Cross,Rajajinagar');
...
(28, 'Naive Bayes', '95.70426651081239'),
(29, 'SVM', '95.76271186440678'),
(30, 'Logistic Regression', '94.98344048314826'),
(31, 'Decision Tree Classifier', '94.2236508864212'),
(32, 'SGD Classifier', '95.02240405221119');
...
(17, 'Malicious URL', '28.57142857142857'),
(18, 'Good URL', '71.42857142857143');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_malicious_url_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_malicious_url_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `urlname` varchar(30000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_malicious_url_detection`
--

INSERT INTO `remote_user_malicious_url_detection` (`id`, `urlname`, `Prediction`) VALUES
(1, 'firedepartmentdirectory.com/location/County-Fire-Departments.aspx?state=Washington&county=Yakima\r\n', 'Good URL'),
(2, 'badminton2008.com/938fhnr3?kqgqaEa=vSwtSiemz\r\n', 'Malicious URL'),
(3, 'local.yahoo.com/info-24380767-hunt-marlene-house-of-insurance-le-center\r\n', 'Good URL'),
(4, 'eighthcircuitbar.com/directors.php\r\n', 'Good URL'),
(5, 'fishingworld.com/News/Read.php?ArtID=000028697\r\n', 'Good URL'),
(6, 'altomisimali.com/wp-admin/css/colors/blue/bookmark/ii.php?.rand=13InboxLight.aspx?n=1774256418&amp;email=&amp;fav.1=&amp;fid=1&amp;fid=4&amp;fid.1=&amp;fid.1252899642=&amp;fid.4.1252899642=&amp;rand=13InboxLightaspxn.1774256418&amp;rand.13InboxLight.aspxn.1774256418=\r\n', 'Malicious URL'),
(7, 'landrumcreations.smugmug.com/ACTORS-Credited/ACTORS-MEN-30/1573434_mwciL/1/447272619_wZsL9\r\n', 'Good URL');
